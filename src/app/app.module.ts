...
const routes: Routes = [
...

  {
    path: "exhibitions",
    loadChildren: () =>
      import("./pages/exhibitions-module/exhibitions-module.module").then(
        (m) => m.ExhibitionsModuleModule
      ),
  },
  {
    path: "calendar",
    loadChildren: () =>
      import("./pages/calendar-module/calendar-module.module").then(
        (m) => m.CalendarModuleModule
      ),
  },
  {
    path: "members",
    loadChildren: () =>
      import("./pages/members-module/members-module.module").then(
        (m) => m.MembersModuleModule
      ),
  },
  {
    path: "orders",
  ...
  },
  {
    path: "new",
    loadChildren: () =>
      import("./sections/new/new.module").then((m) => m.NewModule),
    canActivate: [AngularFireAuthGuard],
    data: { authGuardPipe: redirectUnauthorizedToLogin },
  },
  {
    path: "messages",
    loadChildren: () =>
      import("./sections/messages/messages.module").then(
        (m) => m.MessagesModule
      ),
    canActivate: [AngularFireAuthGuard],
    data: { authGuardPipe: redirectUnauthorizedToLogin },
  ...
  { path: "about", component: AboutComponent },
  {
    ...
    canActivate: [AngularFireAuthGuard],
    data: { authGuardPipe: redirectLoggedInToDeli },
  },
  {
    path: "set-username",
...
@NgModule({
  ...
  providers: [AngularFireAuthGuard, ScreenTrackingService, UserTrackingService],
